...
tags:
  ...
  - name: Metadata
    description: API metadata and endpoint information
servers:
  - url: /hafbe-api
 */
    ...
    "schemas": {
      ...
      "hafbe_backend.endpoint_metadata": {
        ...
        "properties": {
          ...
          "installed": {
            "type": "boolean",
            "description": "true only when the backing SQL function exists in pg_proc AND its parameter names and return type match the OpenAPI declaration"
          },
          "mismatch_reason": {
            "type": "string",
            "description": "When installed is false, explains why — e.g. 'function_not_found', 'parameter_mismatch', 'return_type_mismatch'. NULL when installed is true."
          },
          "parameters": {
            "type": "array",
            "items": {
      ...
      "hafbe_backend.consistency_issue": {
        ...
        "properties": {
          "issue_type": {
            "type": "string",
            "description": "Type of inconsistency: openapi_not_installed, installed_not_rewritten, rewritten_not_in_openapi, rewrite_target_mismatch, rewrite_rules_not_loaded, rewrite_rules_stale"
          },
          "path": {
            "type": "string",
  ...
  "paths": {
    ...
    "/metadata/consistency": {
      "get": {
        ...
        "description": "Cross-validates three layers of endpoint deployment:\n(1) OpenAPI spec paths + operationIds, (2) actual installed SQL functions,\n(3) nginx rewrite rules mirror table. Returns any mismatches including\nrewrite-rules-not-loaded and stale-mirror warnings.\n\nSQL example\n* `SELECT * FROM hafbe_endpoints.get_endpoints_consistency();`\n\nREST call example\n* `GET ''https://%1$s/hafbe-api/metadata/consistency''`\n",
        "operationId": "hafbe_endpoints.get_endpoints_consistency",
        "responses": {
          "200": {
            "description": "Consistency report across all three layers\n\n* Returns `hafbe_backend.endpoints_consistency_response`\n",
            "content": {
              "application/json": {
                "schema": {
