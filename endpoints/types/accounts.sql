...
hafbe_backend.account_activity_summary:
  ...
  properties:
    ...
    block_range:
      $ref: '#/components/schemas/hafbe_backend.block_range'
      description: queried block range
    transfers:
      type: integer
      description: number of transfer operations
    comments:
      type: integer
      description: number of comment operations
    votes:
      type: integer
      description: number of vote operations
    witness_votes:
      type: integer
      description: number of witness vote operations
    proposal_votes:
      type: integer
      description: number of proposal vote operations
    last_activity_block:
      type: integer
      description: block number of the most recent activity
 ...
 */
-- openapi-generated-code-begin
DROP TYPE IF EXISTS hafbe_backend.account_activity_summary CASCADE;
CREATE TYPE hafbe_backend.account_activity_summary AS (
    "account" TEXT,
    "block_range" hafbe_backend.block_range,
    "transfers" INT,
    "comments" INT,
